const top_rated_api_url =
  "https://api.rawg.io/api/games?key=cb97c37fb7a240e8bb7c42e4c27a5623&platforms=187&dates=2023-01-01,2023-06-01&ordering=-rating";
...
async function getPopular() {
  ...
  for (let count = 0; count < 5; count++) {
    ...
    let blockTextWrapper = createNode("div");
    addClass(blockTextWrapper, "block-text-wrapper");
    ...
    blockTextWrapper.appendChild(timeWrapper);
    blockTextWrapper.appendChild(titleWrapper);
    blockTextWrapper.appendChild(commentsWrapper);
    ...
    stackItemWrapper.appendChild(blockTextWrapper);
